...
public class ChuckSales: FINporter {
    override public var name: String { "Chuck Sales" }
    override public var id: String { "chuck_sales" }
    override public var description: String { "Detect and decode realized sale export files from Schwab." }
