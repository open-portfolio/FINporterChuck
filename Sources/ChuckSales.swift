...
public class ChuckSales: FINporter {
    public override var name: String { "Chuck Sales" }
    public override var id: String { "chuck_sales" }
    public override var description: String { "Detect and decode realized sale export files from Schwab." }
